...
public class EditarCliente extends javax.swing.JInternalFrame {
    ...
    private ClienteDAO dao = new ClienteDAO(JpaUtil.getEM());
    private List<Cliente> listaClientes = dao.listarClientes();
    private ClienteTableModel modelo = new ClienteTableModel(listaClientes);
    ...
    public static synchronized EditarCliente getInstance() {
...
//        limpar(Arrays.asList(nome, endereco, cidade, cep, email, telefone));
    ...
    private void initComponents() {
        ...
        alterar.setText("ALTERAR CLIENTE");
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        ...
        if (tabela.getSelectedRow() != -1 && !listaClientes.isEmpty()) {
            dao.removerCliente(modelo.removeRow(tabela.getSelectedRow()));
    ...
    private void alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarActionPerformed
        ...
        if (tabela.getSelectedRow() != -1 && !listaClientes.isEmpty()) {
            ...
            Cliente modificado;
            modificado = listaClientes.get(tabela.getSelectedRow());
            ...
            if (verificar) {
                dao.atualizarCliente(modificado);
                limpar(Arrays.asList(nome, endereco, cidade, cep, email, telefone));
