...
import com.poo.entidades.Endereco;
...
//        limpar(Arrays.asList(nome, cpf, email, endereco, cidade, cep, telefone));
    ...
    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
        ...
        try {
            ...
            Cliente cliente = new Cliente(nome.getText(), cpf.getText(), end, telefone.getText(),
                    email.getText());
            ...
            if (listaClientes.isEmpty()) {
                ...
                for (Cliente listaCliente : listaClientes) {
                    if (cliente.equals(listaCliente)) {
                        throw new EntidadeException("Esse Cliente já foi cadastrado!");
                    }
                }
                dao.inserirCliente(cliente);
                JOptionPane.showMessageDialog(null, "Cliente Cadastrado com sucesso! ");
